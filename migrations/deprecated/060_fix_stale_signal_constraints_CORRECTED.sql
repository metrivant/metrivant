-- =============================================================================
-- Migration 060 CORRECTED: Fix stale signal CHECK constraints blocking pool signals
-- =============================================================================
--
...
--
-- CORRECTION 2026-03-27: Original migration 060 omitted 'pool_event' from
-- source_type constraint, blocking promote-careers-signals and other handlers
-- that use source_type='pool_event'. This corrected version includes it.
--
...
-- CORRECTED: Include 'pool_event' in addition to 'page_diff' and 'feed_event'
