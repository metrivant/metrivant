...
const FEATURES = [
  {
    Icon: IconRadar,
    tag: "Live Radar",
    headline: "See who's moving. Instantly.",
    body: "Up to 25 competitors on one radar. Distance from center = momentum. Size = activity rate. Know who demands attention before the market reacts.",
  },
  {
    Icon: IconSignal,
    tag: "Signal Detection",
    headline: "Every change. Confidence-scored.",
    body: "Pricing shifts, feature launches, messaging updates — automatically detected and classified with confidence scores. Intelligence, not noise.",
  },
  {
    Icon: IconMovement,
    tag: "Strategic Movements",
    headline: "Where they're heading, not where they were.",
    body: "Signals cluster into movements with velocity, confidence, and strategic context. See trajectory, not just change.",
  },
  {
    Icon: IconAlert,
    tag: "Real-Time Alerts",
    headline: "Critical moves. Immediate notification.",
    body: "When a competitor accelerates — high momentum, fresh signals, confirmed movement — you know instantly. Not daily. Not weekly. Now.",
  },
  {
    Icon: IconBrief,
    tag: "Weekly Briefs",
    headline: "Strategic digest. Every Monday.",
    body: "AI-synthesized intelligence report covering movements, patterns, and sector trends. What happened, what it means, what to do.",
  },
  {
    Icon: IconStrategy,
    tag: "Cross-Competitor Patterns",
    headline: "See what individual views miss.",
    body: "Feature convergence, pricing competition, enterprise shifts across all rivals. Patterns requiring 2+ competitors to detect.",
  },
  {
    Icon: IconMap,
    tag: "Market Positioning",
    headline: "Track competitive repositioning.",
    body: "2×2 map scoring competitors on Market Focus and Customer Segment. Shifts >15 points trigger repositioning alerts.",
  },
  {
    Icon: IconEvidence,
    tag: "Evidence-Grounded",
    headline: "Every claim traces to source.",
    body: "Click any signal to see the exact diff. Before/after text, page source, timestamp, confidence. No speculation.",
  },
  {
    Icon: IconConstellation,
    tag: "Telescope",
    headline: "Top 5 signals. Auto-cycling.",
    body: "High-confidence detection feed (≥0.65) with scanning animations. Surfaces critical signals you need to act on.",
  },
  {
    Icon: IconDiscover,
    tag: "Sector Coverage",
    headline: "Five markets. Growing.",
    body: "SaaS, Defense, Energy, Fintech, Cybersecurity — with sector-specific terminology. Add any competitor in seconds.",
  },
] as const;
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <span
                  className="text-[9px] font-bold uppercase tracking-[0.30em]"
                      ...
                      <div className="flex items-start gap-3.5">
                        ...
                        <div className="min-w-0 flex-1">
                          <div
                            ...
                            style={{ fontFamily: "var(--font-orbitron)", color: isPrimal ? "rgba(217,119,6,0.70)" : "rgba(0,180,255,0.55)" }}
                          >
                            {tag}
                          </div>
