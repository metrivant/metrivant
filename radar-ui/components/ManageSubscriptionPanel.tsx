...
type Props = {
  plan: string;
  trialActive: boolean;
  trialExpiredAt: string; // ISO string
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              style={{
                boxShadow:
                  "0 24px 80px rgba(0,0,0,0.90), 0 0 0 1px rgba(46,230,166,0.05)",
              }}
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, transparent, rgba(46,230,166,0.32), transparent)",
                }}
              />
              ...
              <div className="mb-6 space-y-3 border-t border-[#0e1e0e] pt-5">
                ...
                {!isPro && (
                  <div className="flex justify-between">
                    <span className="text-[12px] text-slate-600">
                      {trialActive ? "Trial expires" : "Trial expired"}
                    </span>
                    <span
                      className="text-[12px] font-medium"
                      style={{ color: trialActive ? "#f59e0b" : "#ef4444" }}
                    >
                      {fmt(trialExpiredAt)}
                    </span>
                  </div>
              ...
              {!isPro && (
                <a
                  href="/pricing"
                  className="mb-3 block rounded-full bg-[#2EE6A6] py-2.5 text-center text-[13px] font-bold text-black transition-opacity hover:opacity-90"
                >
                  Upgrade to Pro
                </a>
              )}
