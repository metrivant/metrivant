    ...
    <>
      ...
      <motion.button
        ...
        className="
          ...
          transition-colors
        "
        style={{ color: "rgba(46,230,166,0.65)", writingMode: "vertical-rl" }}
        whileHover={{
          boxShadow: "0 0 16px rgba(46,230,166,0.12), inset 0 0 8px rgba(46,230,166,0.04)",
      ...
      >
        ...
        <span
          ...
          style={{ background: "#2EE6A6", opacity: 0.70, flexShrink: 0 }}
        />
        Features
      </motion.button>
      ...
      <motion.button
        ...
        whileHover={{
          boxShadow: "0 0 14px rgba(46,230,166,0.14)",
          borderColor: "rgba(46,230,166,0.30)",
        }}
        whileTap={{ scale: 0.96 }}
      ...
      >
        ...
        <svg width="14" height="14" viewBox="0 0 28 28" fill="none" aria-hidden="true">
          <circle cx="14" cy="14" r="12.5" stroke="#2EE6A6" strokeWidth="1.2" strokeOpacity="0.45" />
          <circle cx="14" cy="14" r="7.5"  stroke="#2EE6A6" strokeWidth="1"   strokeOpacity="0.28" />
          <line x1="14" y1="14" x2="22" y2="5.8" stroke="#2EE6A6" strokeWidth="1.5" strokeOpacity="0.80" />
          <circle cx="14" cy="14" r="2" fill="#2EE6A6" fillOpacity="0.90" />
        </svg>
        Features
      </motion.button>
