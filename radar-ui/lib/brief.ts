...
export function buildBriefEmailHtml(
  ...
  const sectionLabel = (text: string) =>
    `<div style="font-size:9px;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:#00B4FF;margin-bottom:10px;">${text}</div>`;
  ...
  const radarSvg = `<svg width="64" height="64" viewBox="0 0 64 64" style="display:block;" aria-hidden="true">
    <circle cx="32" cy="32" r="28" fill="none" stroke="rgba(0,180,255,0.15)" stroke-width="1"/>
    <circle cx="32" cy="32" r="20" fill="none" stroke="rgba(0,180,255,0.18)" stroke-width="1"/>
    <circle cx="32" cy="32" r="12" fill="none" stroke="rgba(0,180,255,0.22)" stroke-width="1"/>
    <line x1="32" y1="4"  x2="32" y2="60" stroke="rgba(0,180,255,0.10)" stroke-width="0.8"/>
    <line x1="4"  y1="32" x2="60" y2="32" stroke="rgba(0,180,255,0.10)" stroke-width="0.8"/>
    <circle cx="32" cy="32" r="2.5" fill="rgba(0,180,255,0.55)"/>
    <circle cx="44" cy="22" r="2" fill="#ef4444" fill-opacity="0.70"/>
    <circle cx="24" cy="38" r="1.5" fill="#f59e0b" fill-opacity="0.65"/>
    <circle cx="50" cy="36" r="1" fill="rgba(0,180,255,0.50)"/>
  </svg>`;
    ...
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:14px;border:1px solid #cbd5e1;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.07);">
        ...
        <td style="background:#030c06;padding:24px 32px;">
          <table width="100%" cellpadding="0" cellspacing="0"><tr>
            <td style="vertical-align:middle;">
              <div style="font-size:9px;font-weight:700;letter-spacing:0.26em;text-transform:uppercase;color:rgba(0,180,255,0.60);margin-bottom:4px;">Competitive Intelligence</div>
      ...
      <tr>
        <td style="padding:0 32px;">
          <table width="100%" cellpadding="0" cellspacing="0"><tr>
            <td style="border-left:3px solid rgba(0,180,255,0.55);padding:16px 0 16px 16px;margin:20px 0;">
              <div style="font-size:9px;font-weight:700;letter-spacing:0.20em;text-transform:uppercase;color:#00B4FF;margin-bottom:7px;">Intelligence Quote</div>
      ...
      <tr>
        <td style="padding:20px 32px 24px;border-top:1px solid #f1f5f9;margin-top:8px;">
          <div style="font-size:11px;color:#94a3b8;line-height:1.75;">
            ...
            <a href="${dashboardUrl}/app/briefs" style="color:#00B4FF;text-decoration:none;font-weight:500;">View all briefs in your dashboard &rarr;</a>
          </div>
        </td>
      </tr>
