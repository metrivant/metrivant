...
export const SIGNAL_TYPE_COLORS: Record<string, { bg: string; text: string }> = {
  ...
  product_release:   { bg: "rgba(46,230,166,0.10)",   text: "#2EE6A6" },
    ...
    <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:12px;border:1px solid #e5e7eb;overflow:hidden;">
      ...
      <tr>
        <td style="padding:20px 28px 4px;">
          <div style="font-size:11px;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;color:#2EE6A6;margin-bottom:8px;">
      ...
      <tr>
        <td style="padding:20px 28px;">
          <a href="${siteUrl}/app" style="display:inline-block;background:#2EE6A6;color:#020802;font-weight:700;font-size:13px;padding:10px 22px;border-radius:99px;text-decoration:none;">View on radar &rarr;</a>
        </td>
      </tr>
      <tr>
