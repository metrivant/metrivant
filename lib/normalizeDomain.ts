 ...
 *
 * This is the single source of truth for domain normalization across the
 * pipeline runtime. All competitor identity operations must use this function
 * so that https://linear.app, http://linear.app, and https://linear.app/pricing
